...
import { Plus, ShoppingCart, TrendingUp, Calendar, DollarSign, Edit, Trash2, AlertTriangle } from "lucide-react";
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {activeBudgets.map((budget) => {
                ...
                const progress = calculateProgress(budget.spent, budget.allocatedAmount);
